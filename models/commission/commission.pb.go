...
const file_commission_commission_proto_rawDesc = "" +
	...
	"commission\x1a7sologenic/com-fs-utils-lib/models/decimal/decimal.proto\x1a\x1bbuf/validate/validate.proto\"\x9b\x05\n" +
	"\x12CommissionSettings\x12\x8a\x04\n" +
	"\n" +
	"Commission\x18\x19 \x01(\v2\x10.decimal.DecimalB\xd2\x03\xbaH\xce\x03\xba\x01\xc7\x03\n" +
	"$commission_settings.commission.range\x12ECommission must be between 0 and 10000 with at most 2 fraction digits\x1a\xd7\x02this.Value >= 0 && this.Exp >= -2 && (this.Value == 0 || (this.Exp == -2 && this.Value <= 1000000) || (this.Exp == -1 && this.Value <= 100000) || (this.Exp == 0 && this.Value <= 10000) || (this.Exp == 1 && this.Value <= 1000) || (this.Exp == 2 && this.Value <= 100) || (this.Exp == 3 && this.Value <= 10) || (this.Exp == 4 && this.Value <= 1))\xc8\x01\x01H\x00R\n" +
