...
const file_commission_commission_proto_rawDesc = "" +
	...
	"commission\x1a7sologenic/com-fs-utils-lib/models/decimal/decimal.proto\x1a\x1bbuf/validate/validate.proto\"\x8c\x03\n" +
	"\x12CommissionSettings\x12\xfb\x01\n" +
	"\n" +
	"Commission\x18\x19 \x01(\v2\x10.decimal.DecimalB\xc3\x01\xbaH\xbf\x01\xba\x01\xb8\x01\n" +
	"$commission_settings.commission.range\x12ECommission must be between 0 and 10000 with at most 2 fraction digits\x1aIthis.Value >= 0 && this.Value <= 10000 && this.Exp >= -2 && this.Exp <= 0\xc8\x01\x01H\x00R\n" +
